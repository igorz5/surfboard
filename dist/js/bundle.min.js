...
"use strict";var sections=$(".section"),content=$(".page-content"),scrollTimeoutMS=400,currentPage=0,nextPageScroll=Date.now(),canScroll=!0;function nextPage(){!canScroll||currentPage>sections.length-1||nextPageScroll>Date.now()||(scrollToPage(++currentPage),nextPageScroll=Date.now()+scrollTimeoutMS)}function prevPage(){!canScroll||currentPage>sections.length-1||nextPageScroll>Date.now()||(scrollToPage(--currentPage),nextPageScroll=Date.now()+scrollTimeoutMS)}function scrollToPage(e){0<=e&&e<=sections.length-1&&(content.css("transform","translateY(".concat(-(100*e),"%)")),currentPage=e,updateFixedMenu())}function getSectionIndexByName(n){return sections.toArray().findIndex(function(e){return $(e).attr("data-section")===n})}function getCurrentPage(){return currentPage}function lockScroll(){canScroll=!1}function unlockScroll(){canScroll=!0}window.addEventListener("load",function(){this.scrollTo(0,0)}),window.addEventListener("wheel",function(e){(0<e.deltaY?nextPage:prevPage)()});var startY=0,endY=0,minDist=40,touchMoved=!1;$("body").on("touchstart",function(e){startY=e.touches[0].screenY}),$("body").on("touchmove",function(e){endY=e.touches[0].screenY,touchMoved=!0}),$("body").on("touchend",function(e){var n,t;touchMoved&&(touchMoved=!1,n=startY-endY,t=Math.sign(n),Math.abs(n)>=minDist&&(0<t?nextPage():t<0&&prevPage()))});
"use strict";var orderForm=$(".order__form"),orderSubmit=$(".order__btn-submit"),orderFieldNames=["name","phone","house","flat","comment"],orderFields={},url=(orderFieldNames.forEach(function(e){var r=orderForm.find(":input[name=".concat(e,"]"),"textarea[name=".concat(e,"]"));(orderFields[e]=r).keyup(function(){$(this).hasClass("order__input--invalid")&&checkFieldValidity($(this))})}),"https://webdev-api.loftschool.com/sendmail");function checkFieldValidity(e){var r=e[0]&&e[0].checkValidity();return r?e.removeClass("order__input--invalid"):e.addClass("order__input--invalid"),r}function checkFormValidity(){var r=!0;return Object.values(orderFields).forEach(function(e){if(!checkFieldValidity(e))return r=!1}),r}orderForm.trigger("reset"),orderForm.on("submit",function(e){var t;e.preventDefault(),checkFormValidity()&&(e={name:orderFields.name.val(),phone:orderFields.phone.val(),comment:orderFields.comment.val(),to:"test@gmail.com"},(t=new XMLHttpRequest).open("POST",url),t.setRequestHeader("content-type","application/json"),t.addEventListener("load",function(){var e=JSON.parse(t.response),r=0===e.status;openModal(e.message,r,function(){orderForm.trigger("reset")})}),t.send(JSON.stringify(e)))}),orderSubmit.on("click",function(e){checkFormValidity()});
