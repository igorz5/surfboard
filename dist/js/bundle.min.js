...
"use strict";var boardsList=$(".boards__list");boardsList.slick({prevArrow:".boards__prev",nextArrow:".boards__next"});
"use strict";var fixedMenuItems=$(".fixed-menu__item"),fixedMenuLinks=$(".fixed-menu__link");function updateFixedMenu(){fixedMenuItems.each(function(){$(this).removeClass("fixed-menu__item--active");var e=$(this).find(".fixed-menu__link"),e=getSectionIndexByName(e.attr("data-section"));getCurrentPage()===e&&$(this).addClass("fixed-menu__item--active")})}fixedMenuLinks.on("click",function(){scrollToPage(getSectionIndexByName($(this).attr("data-section")))});
"use strict";var hamburger=$(".header__hamburger"),fullscreenNavbar=$(".fullscreen-navbar"),navbarClose=$(".fullscreen-navbar__close"),navbarItems=$(".fullscreen-navbar .navbar__item");function openFullscreenNavbar(){fullscreenNavbar.addClass("fullscreen-navbar--active"),lockScroll()}function closeFullscreenNavbar(){fullscreenNavbar.removeClass("fullscreen-navbar--active"),unlockScroll()}hamburger.on("click",function(){openFullscreenNavbar()}),navbarClose.on("click",function(){closeFullscreenNavbar()}),navbarItems.each(function(){$(this).on("click",function(){closeFullscreenNavbar()})});
"use strict";ymaps.ready(function(){var e=new ymaps.Map("map",{center:[55.76,37.64],zoom:14,controls:[]}),a=new ymaps.GeoObjectCollection({},{draggable:!1,iconLayout:"default#image",iconImageHref:"../img/marker.svg",iconImageSize:[76,95],iconImageOffset:[-40,-70]});[[55.76,37.64],[55.77,37.66],[55.78,37.62],[55.79,37.67]].forEach(function(e){a.add(new ymaps.Placemark(e))}),e.geoObjects.add(a),e.behaviors.disable("scrollZoom")});
"use strict";var menuItems=$(".menu__item");menuItems.on("click",function(e){var t;$(e.target).hasClass("menu__btn")&&((t=$(this)).toggleClass("menu__item--active"),menuItems.each(function(){$(this).is(t)||$(this).removeClass("menu__item--active")}))});
"use strict";var modal=$(".modal"),modalText=$(".modal__text"),modalBtn=$(".modal__btn"),closeCallback=null;function openModal(l){var o=1<arguments.length&&void 0!==arguments[1]&&arguments[1],a=2<arguments.length?arguments[2]:void 0;isModalOpen()||(modal.addClass("modal--active"),modalText.text(l),lockScroll(),o?modalText.css("color","#fd3f44"):modalText.css("color","inherit"),closeCallback=a)}function closeModal(){isModalOpen()&&(modal.removeClass("modal--active"),modalText.text(""),unlockScroll(),closeCallback&&(closeCallback(),closeCallback=null))}function isModalOpen(){return modal.hasClass("modal--active")}modalBtn.on("click",function(){closeModal()});
"use strict";var navbarLinks=$(".navbar__link");navbarLinks.on("click",function(){scrollToPage(getSectionIndexByName($(this).attr("data-section")))});
"use strict";var sections=$(".section"),content=$(".page-content"),scrollTimeoutMS=400,currentPage=0,nextPageScroll=Date.now(),canScroll=!0;function nextPage(){!canScroll||currentPage>=sections.length-1||nextPageScroll>Date.now()||(scrollToPage(++currentPage),nextPageScroll=Date.now()+scrollTimeoutMS)}function prevPage(){!canScroll||currentPage<=0||nextPageScroll>Date.now()||(scrollToPage(--currentPage),nextPageScroll=Date.now()+scrollTimeoutMS)}function scrollToPage(e){0<=e&&e<=sections.length-1&&(content.css("transform","translateY(".concat(-(100*e),"%)")),currentPage=e,updateFixedMenu())}function getSectionIndexByName(t){return sections.toArray().findIndex(function(e){return $(e).attr("data-section")===t})}function getCurrentPage(){return currentPage}function lockScroll(){canScroll=!1}function unlockScroll(){canScroll=!0}window.addEventListener("wheel",function(e){(0<e.deltaY?nextPage:prevPage)()});var startY=0,endY=0,lastTime=0,startTimeReset=60,minDist=40;$("body").on("touchstart",function(e){1<e.touches.length||(startY=e.touches[0].screenY,endY=startY)}),$("body").on("touchmove",function(e){1<e.touches.length||(e.timeStamp>lastTime+startTimeReset&&(startY=e.touches[0].screenY),endY=e.touches[0].screenY,lastTime=e.timeStamp)}),$("body").on("touchend",function(e){var t=startY-endY,n=Math.sign(t);Math.abs(t)>=minDist&&(0<n?nextPage:prevPage)()});
"use strict";var orderForm=$(".order__form"),orderSubmit=$(".order__btn-submit"),orderFieldNames=["name","phone","house","flat","comment"],orderFields={},url=(orderFieldNames.forEach(function(e){var r=orderForm.find(":input[name=".concat(e,"]"),"textarea[name=".concat(e,"]"));(orderFields[e]=r).keyup(function(){$(this).hasClass("order__input--invalid")&&checkFieldValidity($(this))})}),"https://webdev-api.loftschool.com/sendmail");function checkFieldValidity(e){var r=e[0]&&e[0].checkValidity();return r?e.removeClass("order__input--invalid"):e.addClass("order__input--invalid"),r}function checkFormValidity(){var r=!0;return Object.values(orderFields).forEach(function(e){if(!checkFieldValidity(e))return r=!1}),r}orderForm.trigger("reset"),orderForm.on("submit",function(e){var o;e.preventDefault(),checkFormValidity()&&(e={name:orderFields.name.val(),phone:orderFields.phone.val(),comment:orderFields.comment.val(),to:"test@gmail.com"},(o=new XMLHttpRequest).open("POST",url),o.setRequestHeader("content-type","application/json"),o.addEventListener("load",function(){var e=JSON.parse(o.response),r=0===e.status;openModal(e.message,r,function(){orderForm.trigger("reset")})}),o.addEventListener("error",function(){openModal("Упс... Произошла ошибка",!0,function(){orderForm.trigger("reset")})}),o.send(JSON.stringify(e)))}),orderSubmit.on("click",function(e){checkFormValidity()});
"use strict";var playBtn=$(".player__play-btn"),playerSplash=$(".player__splash"),playerControls=$(".player__controls"),playerProgress=$(".player__progress"),playerVolumeLine=$(".player__volume-line"),playerProgressCurrent=$(".player__timeline .player__current"),playerVolumeCurrent=$(".player__volume .player__current"),playerProgressHandler=$(".player__progress-handler"),playerVolumeHandler=$(".player__volume-handler"),playerVolumeBtn=$(".player__volume-btn"),player=null,targetPressed=null,lastVolume=0,preventProgressUpdate=!1;function onYouTubeIframeAPIReady(){player=new YT.Player("player-display",{height:"100%",width:"100%",videoId:"86E7FuIfo_k",playerVars:{controls:0,modestbranding:0,rel:0,showinfo:0,autoplay:0},events:{onReady:onPlayerReady,onStateChange:onPlayerStateChange}})}function onPlayerReady(){playBtn.on("click",function(){player.getPlayerState()!==YT.PlayerState.PLAYING?player.playVideo():player.pauseVideo()});function e(e){return function(){targetPressed=e}}function r(e){var r;null!=targetPressed&&(r=0,r=("touchmove"===e.type?e.touches[0]:e).pageX,targetPressed.is(playerProgressHandler)?setPlayerElapsedTime((r-playerProgress.offset().left)/playerProgress.width()*player.getDuration()):targetPressed.is(playerVolumeHandler)&&(e=r-playerVolumeLine.offset().left,r=playerVolumeLine.width(),player.setVolume(100*(e/r))))}function a(){targetPressed=null}playerProgressHandler.on("mousedown",e(playerProgressHandler)),playerProgressHandler.on("touchstart",e(playerProgressHandler)),playerVolumeHandler.on("mousedown",e(playerVolumeHandler)),playerVolumeHandler.on("touchstart",e(playerVolumeHandler)),playerControls.on("mousemove",r),playerControls.on("touchmove",r);playerControls.on("mouseup",a),playerControls.on("mouseleave",a),playerControls.on("touchend",a),playerProgress.on("click",function(e){setPlayerElapsedTime((e.pageX-playerProgress.offset().left)/playerProgress.width()*player.getDuration())}),playerVolumeLine.on("click",function(e){var e=e.pageX-$(this).offset().left,r=$(this).width();player.setVolume(Math.floor(e/r*100))}),playerVolumeBtn.on("click",function(){0===player.getVolume()?player.setVolume(lastVolume):(lastVolume=player.getVolume(),player.setVolume(0))}),setInterval(function(){player.getPlayerState()!==YT.PlayerState.PLAYING||preventProgressUpdate||updatePlayerProgress(),preventProgressUpdate=!1,updateVolume()},10)}function onPlayerStateChange(e){e.data===YT.PlayerState.PLAYING?(playBtn.addClass("player__play-btn--pause"),playerSplash.hide()):e.data!==YT.PlayerState.PAUSED&&e.data!==YT.PlayerState.ENDED||(playBtn.removeClass("player__play-btn--pause"),playerSplash.show(),e.data===YT.PlayerState.ENDED&&(player.seekTo(0),player.pauseVideo()))}function updatePlayerProgress(e){null==e&&(e=player.getCurrentTime());var r=player.getDuration(),e=(0===r&&playerProgressCurrent.css("width","0%"),e/r);playerProgressCurrent.css("width","".concat(100*e,"%")),preventProgressUpdate=!0}function updateVolume(){var e=player.getVolume();playerVolumeCurrent.css("width","".concat(e,"%"))}function setPlayerElapsedTime(e){player.seekTo(e),updatePlayerProgress(e)}
"use strict";var reviews=$(".reviews__item"),paginationItems=$(".reviews__pagination-item");paginationItems.on("click",function(i){var e,t;$(i.target).hasClass("reviews__pagination-btn")&&(e=$(this).attr("data-review-id"),reviews.each(function(){var i=$(this).attr("data-review-id");if(e===i)return t=$(this),!1}),t&&(reviews.removeClass("reviews__item--active"),t.addClass("reviews__item--active"),paginationItems.removeClass("reviews__pagination-item--active"),$(this).addClass("reviews__pagination-item--active")))});
"use strict";var teamList=$(".team__list"),teamCards=$(".team-card");teamCards.on("click",function(a){var t;$(a.target).hasClass("team-card__name")&&($(this).toggleClass("team-card--active"),t=$(this),teamCards.each(function(){$(this).is(t)||$(this).removeClass("team-card--active")}))});
